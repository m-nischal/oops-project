...
"[project]/src/pages/api/wholesaler/retailer-analytics.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (!retailerEmail) {
        return res.status(400).json({
            error: "retailerEmail is required."
        });
    }
    // --- 3. Fetch Analytics ---
    try {
        const retailerOrders = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$orderModel$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].find({
            sellerId: sellerId,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d87ee3ea._.js.map