...
"[project]/Project OOPS/src/pages/api/wholesaler/analytics.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        const payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$lib$2f$auth$2e$js__$5b$api$5d$__$28$ecmascript$29$__["verifyToken"])(req);
    ...
    try {
        ...
        const allOrders = await __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$models$2f$orderModel$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].find({
            sellerId: sellerId
        }).lean();
        // Initialize counters
        let totalSales = 0;
        ...
        const salesData = await __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$models$2f$orderModel$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].aggregate([
            {
                $match: {
                    sellerId: sellerId,
                    status: 'delivered',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c2ec82b3._.js.map