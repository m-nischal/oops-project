...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/models/Product.js [api] (ecmascript)");
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs)"); // Import mongoose
;
;
;
;
...
async function handler(req, res) {
    ...
    if (!payload || !payload.customer || !Array.isArray(payload.items) || payload.items.length === 0) {
        return res.status(400).json({
            error: "Invalid order payload: customer and items are required."
        });
    }
    ...
    try {
        ...
        const firstProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].findById(firstProductId).select("ownerId").lean();
        if (!firstProduct || !firstProduct.ownerId) {
            return res.status(400).json({
                error: "Could not find product owner (seller)."
            });
        }
        ...
        const orderDoc = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$orderService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].createOrder(payload.customer, payload.items, sellerId // This is the new required field
        );
        // 3. Success!
        ...
        if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$orderService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["InsufficientStockError"]) {
            return res.status(409).json({
                error: "Insufficient stock",
                message: err.message
            });
        }
        if (err instanceof __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$orderService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["OrderError"]) {
            return res.status(400).json({
                error: "Invalid order",
                message: err.message
            });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__703452b1._.js.map