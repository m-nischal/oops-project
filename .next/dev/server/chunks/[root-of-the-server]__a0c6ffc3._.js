...
"[project]/Project OOPS/src/pages/api/auth/[...nextauth].js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const __TURBOPACK__default__export__ = (0, __TURBOPACK__imported__module__$5b$externals$5d2f$next$2d$auth__$5b$external$5d$__$28$next$2d$auth$2c$__cjs$29$__["default"])({
    ...
    callbacks: {
        async signIn ({ user, account, profile, email, credentials }) {
            ...
            const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$models$2f$User$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].findOne({
                email: user.email
            });
            if (!existing) {
                await __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$models$2f$User$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].create({
                    name: user.name,
                    email: user.email,
        ...
        async jwt ({ token, user }) {
            ...
            if (!token.role) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$lib$2f$dbConnect$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"])();
                const u = await __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$models$2f$User$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].findOne({
                    email: token.email
                });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__a0c6ffc3._.js.map