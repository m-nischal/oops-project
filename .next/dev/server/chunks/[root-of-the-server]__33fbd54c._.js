...
"[project]/Project OOPS/src/models/Product.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Project OOPS/src/services/catalogService.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Project OOPS/src/models/Product.js [api] (ecmascript)");
;
/**
 ...
 */ async function getProducts(filter = {}, options = {}) {
    ...
    // Build the query
    let query = __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].find(filter).sort(sort).skip(skip).limit(limit);
    if (lean) {
        query = query.lean();
    }
    ...
    if (lean && Array.isArray(results)) {
        const computed = results.map((p)=>{
            try {
                const ts = __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].computeTotalStockForPlainObject(p);
...
"[project]/Project OOPS/src/pages/api/products/index.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$services$2f$catalogService$2e$js__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Project OOPS/src/services/catalogService.js [api] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Project OOPS/src/models/Product.js [api] (ecmascript)"); // used to compute count
;
;
;
async function handler(req, res) {
    ...
    if (req.method === "GET") {
        try {
            ...
            const products = await __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$services$2f$catalogService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].getProducts(filter, {
                lean: true,
                limit: Number(limit),
                skip,
                sort: {
            ...
            const total = await __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].countDocuments(filter);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__33fbd54c._.js.map