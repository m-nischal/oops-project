...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/models/Product.js [api] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$js__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/models/User.js [api] (ecmascript)"); // Required to check buyer role
...
class OrderService {
   ...
   */ static async _transferStockToRetailer(order, session) {
        ...
        const buyer = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$User$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].findById(order.userId).session(session);
        ...
        for (const item of order.items){
            ...
            let retailerProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].findOne({
                ownerId: buyer._id,
            ...
            if (retailerProduct) {
                    ...
                    await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].updateOne({
                        ...
                        $push: {
                            sizes: {
                                size: item.sizeLabel,
                                stock: item.qty,
                                sku: `${retailerProduct.slug}-${item.sizeLabel}`
                            }
                        }
                    }, {
                        session
                ...
                const wholesaleProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].findById(item.productId).session(session);
                ...
                await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].create([
                    newProductData
                ], {
                    session
                });
...
"[project]/src/pages/api/retailer/place-wholesale-order.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        ...
        if (!payload || payload.role !== "RETAILER") {
            return res.status(401).json({
                error: "Unauthorized. Retailers only."
            });
        }
    } catch (err) {
        return res.status(401).json({
    ...
    if (!productId || !qty || !size) {
        return res.status(400).json({
            error: "Product, Quantity, and Size are required."
        });
    }
    try {
        // 3. Find the Product to get the Seller (Wholesaler) ID
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].findById(productId);
        ...
        const order = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$orderService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].createOrder(customerData, items, sellerId, retailerId);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__44761aa9._.js.map