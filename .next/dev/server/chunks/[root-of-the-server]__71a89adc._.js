...
async function handler(req, res) {
    await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$dbConnect$2e$js__$5b$api$5d$__$28$ecmascript$29$__["dbConnect"])();
    const { id } = req.query;
    if (!__TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__["default"].isValidObjectId(id)) return res.status(400).json({
        error: "Invalid product id"
    });
    if (req.method === "GET") {
        const product = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$productModel$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].findById(id);
    ...
    if (req.method === "DELETE") {
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$productModel$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].findByIdAndDelete(id);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__71a89adc._.js.map