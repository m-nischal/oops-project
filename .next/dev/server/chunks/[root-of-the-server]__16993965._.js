...
"[project]/src/pages/api/wholesaler/products/[id].js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
    ...
    switch(req.method){
        ...
        case 'PUT':
            try {
                ...
                const updatedProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].findOneAndUpdate({
                    _id: productId,
                    ownerId: sellerId
                }, productData, {
                    new: true,
                    runValidators: true
                } // Options: return the new doc
                );
                if (!updatedProduct) {
                    return res.status(404).json({
                        error: "Product not found or you do not own this product."
...
//# sourceMappingURL=%5Broot-of-the-server%5D__16993965._.js.map