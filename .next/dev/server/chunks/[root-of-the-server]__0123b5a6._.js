...
"[project]/src/pages/api/retailer/customer-analytics.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    try {
        ...
        const customerOrders = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$orderModel$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].find({
            sellerId: sellerId,
            "customer.email": customerEmail //
        }).sort({
            createdAt: -1
        }).limit(50).lean(); // Get last 50 orders
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0123b5a6._.js.map