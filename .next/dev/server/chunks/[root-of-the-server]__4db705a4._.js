...
class InventoryService {
   ...
   */ static async addOrCreateSize(productId, sizeLabel, qty = 0, session = null) {
        ...
        const res = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].updateOne({
            _id: productId,
            "sizes.size": label
        }, {
            $set: {
...
"[project]/src/pages/api/orders/[id].js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function handler(req, res) {
    ...
    if (req.method === "GET") {
        try {
            const order = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$orderService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].getById(id);
    ...
    if (req.method === "PATCH") {
        try {
            ...
            const updated = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$services$2f$orderService$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].updateStatus(id, status, {
                restoreStock
            });
            ...
            if (err.name === "InsufficientStockError") return res.status(409).json({
                error: err.message
            });
            if (err.name === "InvalidOrderParamsError" || err.name === "OrderError") return res.status(400).json({
                error: err.message
            });
            return res.status(500).json({
...
//# sourceMappingURL=%5Broot-of-the-server%5D__4db705a4._.js.map