...
"[project]/Project OOPS/src/lib/auth.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/Project OOPS/src/pages/api/retailer/products.js [api] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Project OOPS/src/models/Product.js [api] (ecmascript)"); // Our updated Product model
var __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$lib$2f$auth$2e$js__$5b$api$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Project OOPS/src/lib/auth.js [api] (ecmascript)"); // Your team's auth verify function
var __TURBOPACK__imported__module__$5b$externals$5d2f$mongoose__$5b$external$5d$__$28$mongoose$2c$__cjs$29$__ = __turbopack_context__.i("[externals]/mongoose [external] (mongoose, cjs)");
;
;
;
...
async function handler(req, res) {
    ...
    let payload;
    try {
        payload = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$lib$2f$auth$2e$js__$5b$api$5d$__$28$ecmascript$29$__["verifyToken"])(req); //
        // We allow both roles here since the dashboard is identical
        if (!payload || payload.role !== "RETAILER" && payload.role !== "WHOLESALER") {
            return res.status(401).json({
                error: "Unauthorized. You must be a Retailer or Wholesaler."
            });
        }
    } catch (err) {
        return res.status(401).json({
    ...
    if (req.method === "GET") {
        try {
            ...
            const products = await __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].find(filter).skip((Number(page) - 1) * Number(limit)).limit(Number(limit)).sort({
                createdAt: -1
            }).lean();
    ...
    if (req.method === "POST") {
        try {
            ...
            const newProduct = await __TURBOPACK__imported__module__$5b$project$5d2f$Project__OOPS$2f$src$2f$models$2f$Product$2e$js__$5b$api$5d$__$28$ecmascript$29$__["default"].create(productData);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__86e80b17._.js.map