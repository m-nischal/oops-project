...
function CartPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$index$2e$js__$5b$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "CartPage.useEffect": ()=>{
            ({
                "CartPage.useEffect": async ()=>{
                    const stored = JSON.parse(localStorage.getItem("lm_cart") || "[]");
                    // For each cart item, fetch inventory and clamp qty to available stock
                    const updated = await Promise.all(stored.map({
                        "CartPage.useEffect": async (item)=>{
                            try {
                                const res = await fetch(`/api/inventory/${item.productId}`);
                                if (!res.ok) return item;
                                const inv = await res.json();
                                // find matching size entry
                                const sizeEntry = (inv.sizes || []).find({
                                    "CartPage.useEffect.sizeEntry": (s)=>s.label === item.sizeLabel
                                }["CartPage.useEffect.sizeEntry"]);
            ...
            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("main", {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: cart.map((item, idx)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                style: {
...
_s(CartPage, "h490C+U195ZVaBVLotFcRtwtMY8=", false, function() {
    return [
...
//# sourceMappingURL=%5Broot-of-the-server%5D__2de01b3a._.js.map